...
namespace QuantConnect.CodingServices.Models
{
    ...
    public class FileCodeCompletionResponse //: BasicResponse
    {
        ...
        [JsonProperty("sTextBeforeCursor")]
        public string TextBeforeCursor { get; set; }

        [JsonProperty("sTextAfterCursor")]
        public string TextAfterCursor { get; set; }

        [JsonProperty("sCompletionWord")]
        public string CompletionWord { get; set; }

        // for the JSON serialized representation, perhaps we should just output the id of the closest match...
